...
PYBIND11_MODULE(_core, m) {
  ...
  py::class_<motion::CartesianTrajectory>(m, "CartesianTrajectory")
      ...
      .def("get_pose", &motion::CartesianTrajectory::getPose, py::arg("time"))
      .def("get_position", &motion::CartesianTrajectory::getPosition,
           py::arg("time"))
      .def("get_orientation", &motion::CartesianTrajectory::getOrientation,
           py::arg("time"));
  ...
  py::class_<IntegratedVelocity, TorqueController,
      ...
      .def("get_qd", &IntegratedVelocity::getQd,
           py::call_guard<py::gil_scoped_release>())
  ...
  py::class_<motion::JointMotion>(m, "JointMotion")
      .def(py::init<const std::array<double, 7> &,
           ...
           "target"_a, "target_d"_a = std::array<double, 7>{0.0})
  ...
  py::class_<motion::CartesianMotion>(m, "CartesianMotion")
      .def(py::init<const Eigen::Vector3d &, const Eigen::Vector4d &,
                    motion::ReferenceFrame>(),
           "position"_a, "orientation"_a,
           "reference_frame"_a = motion::ReferenceFrame::GLOBAL)
      .def(py::init<const Eigen::Matrix4d &, motion::ReferenceFrame>(),
           "pose"_a, "reference_frame"_a = motion::ReferenceFrame::GLOBAL)
      .def_readwrite("velocity_rel", &motion::CartesianMotion::velocity_rel)
      .def_readwrite("acceleration_rel",
                     &motion::CartesianMotion::acceleration_rel)
      .def_readwrite("jerk_rel", &motion::CartesianMotion::jerk_rel)
      .def_readwrite("reference_frame",
                     &motion::CartesianMotion::reference_frame);

  py::class_<motion::MotionData>(m, "MotionData")
      .def(py::init<double, double, double>(), "velocity"_a = 1.0,
           "acceleration"_a = 1.0, "jerk"_a = 1.0)
  ...
  py::class_<motion::Generator, std::shared_ptr<motion::Generator>>(m,
                                                                    "Generator")
      .def("set_done_callback", &motion::Generator::setDoneCallback,
           py::arg("done_callback"));

  py::class_<motion::JointMotionGenerator, motion::Generator,
             std::shared_ptr<motion::JointMotionGenerator>>(
      m, "JointMotionGenerator")
      .def(py::init<bool, std::function<void()>>(),
           py::arg("keep_running") = false, py::arg("done_callback") = nullptr)
      .def("add_waypoint", &motion::JointMotionGenerator::addWaypoint,
           py::arg("waypoint"))
      .def("clear_waypoints", &motion::JointMotionGenerator::clearWaypoints)
      .def("add_waypoints", &motion::JointMotionGenerator::addWaypoints,
           py::arg("waypoints"));

  py::class_<motion::CartesianMotionGenerator, motion::Generator,
             std::shared_ptr<motion::CartesianMotionGenerator>>(
      m, "CartesianMotionGenerator")
      .def(py::init<bool, std::function<void()>>(),
           py::arg("keep_running") = false, py::arg("done_callback") = nullptr)
      .def("add_waypoint", &motion::CartesianMotionGenerator::addWaypoint,
           py::arg("waypoint"))
      .def("clear_waypoints", &motion::CartesianMotionGenerator::clearWaypoints)
      .def("add_waypoints", &motion::CartesianMotionGenerator::addWaypoints,
           py::arg("waypoints"));
}
